...
| 2026-07-18 | **第二 repo 真冷啟動**(marketing_dashboard:GSD 歷史共存、前日真實工作 record、經 v0.7.1 升級路徑;全新 session 單指令) | 讀取面 10.1KB ≈ 3.6K tok(STATE 1.6K + record 6.6K + skill 1.9KB);/cost 全額:510 in + 36.3K cache write + 180.7K cache read + 948 out,$0.96;API 19s / wall 1m33s | | **首筆非自我參照樣本**(n=2)。flightwake 邊際 ≈ 讀取 3.6K + 輸出 0.9K tok,API 19 秒;cache 大宗仍為 harness 底盤(該 repo 指令檔較大故 cache 較高)。主觀正確性:使用者確認接手回報全準、零糾正。兩筆樣本邊際成本一致落在 3–5K tok 級,冷啟動 <2 分鐘,遠低於 5 分鐘契約 |
