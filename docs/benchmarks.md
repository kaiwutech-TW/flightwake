...
|---|---|---|---|---|
| 2026-07-17 | repo-A 冷啟動(溫啟動:同 session 自測) | 讀取面 5.9KB ≈ 2.1K tok;含推理輸出 ≈ 4–5K tok;讀取 12 秒 | `.planning/` 核心四檔 31.3KB ≈ 11K tok,實務含 phase 文件 15–20K tok | 首筆;GSD 側為檔案實量非實跑 |
| — | 待補:全新 session 真冷啟動 | | | 這才是有效樣本 |
