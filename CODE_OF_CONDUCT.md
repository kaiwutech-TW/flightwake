...
privately through GitHub's private reporting form:
<https://github.com/kaiwutech-TW/flightwake/security/advisories/new>
(repo → Security tab → Report a vulnerability). It is the project's private channel to the maintainers; use it
for conduct reports as well, and say up front that the report is about conduct rather than a vulnerability.
