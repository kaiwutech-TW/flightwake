...
強いモデルとの協働が初めてなら:[docs/workflow.md](docs/workflow.md) は「各ステージで**あなた**が何をし、モデルに何と言うか」のステージマップ——本線は初心者向け、「⚙ 進階」の折りたたみは Claude Code 熟練者向け。(現在は zh-TW、英語版は v0.9 i18n で対応予定。)
