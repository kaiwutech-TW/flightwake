...
latest_record: records/260727-oss-pr-flow-hardening.md
health: green
---
...
3. **發 Release 時**:0.10.1 仍未發,CHANGELOG 的 `[Unreleased]` 已備妥本批內容(儀表版本號、bot 排除、dependabot grouping),直接搬即可
