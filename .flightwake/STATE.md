...
latest_record: records/260811-tower-and-registry.md
health: green
---
...
3. **tower/registry 收尾**:核心發 0.13.0(registry 變更,走既有 Release 流程)→ 建 kaiwutech-TW/flightwake-tower repo + trusted publishing → 發 tower 0.1.0 → 常用 repo `npx flightwake update`(一次拿到 0.13.0 + confidence 內容並刷新 registry)
